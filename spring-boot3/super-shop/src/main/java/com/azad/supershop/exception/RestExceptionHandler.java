...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler( {MethodBlockedException.class} )
    public ResponseEntity<Object> handleMethodBlockedException(MethodBlockedException ex, WebRequest webRequest) {
        String error = ex.getMessage();
        ApiError apiError = new ApiError(HttpStatus.INTERNAL_SERVER_ERROR,
                String.valueOf(ex.getCause()), error);
