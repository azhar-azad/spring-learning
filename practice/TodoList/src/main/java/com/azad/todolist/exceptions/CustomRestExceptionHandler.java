...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	 ...
	 * */
	@ExceptionHandler({ InvalidSortItemsException.class })
	public ResponseEntity<Object> handleInvalidSortItemsException(InvalidSortItemsException ex, WebRequest request) {
		
		String error = "Invalid url parameter for sorting.";
	...
	public ResponseEntity<Object> handleResourceBodyEmptyException(RequestBodyEmptyException ex, WebRequest request) {
		
		String error = "Request Body is empty.";
	...
	public ResponseEntity<Object> handleResourceNotFoundException(ResourceNotFoundException ex, WebRequest request) {
		...
		String error = "Resource Not Found with provided identification";
	...
	public ResponseEntity<Object> handleClassNotFoundException(ClassNotFoundException ex, WebRequest request) {
		...
		String error = ex.getException().getMessage();
