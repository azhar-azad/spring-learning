...
public class AppUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        Optional<AppUserEntity> optionalUser = appUserRepo.findByEmail(email);
        ...
        AppUserEntity appUserEntity = optionalUser.get();

        if (appUserEntity.getRole().equalsIgnoreCase("ROLE_ADMIN")) {
        ...
        return new org.springframework.security.core.userdetails.User(
                email, // username
                appUserEntity.getPassword(), // password
